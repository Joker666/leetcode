...
# what condition will make the pointers move?
# The key here is sorting the array. That helps with two things. One to move the pointers, second
...
# When the array is sorted, we can skip the value if it's already handled.
# Next, after storing the values that add upt to 0, we can skip the values that are the same.
